                    ...
                    <table className="table table-bordered table-striped table-sm">
                        ...
                        {props.results.map(item => (
                            <tr>
                                ...
                                <td>
                                    <a href={"https://webtopdf.expeditedaddons.com/?api_key=53YH4OUM7G8Q9BJI4NVF6CW590X0SDZT7L1KEA8R3621P2&content=https://app-covidd.herokuapp.com/sertificate/" + item.id + "&margin=0&html_width=1240"} target="_blank">
